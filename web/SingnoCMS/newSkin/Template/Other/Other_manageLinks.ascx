...
<table class="tables" cellpadding="0" cellspacing="0">
	...
	<tbody id="ctrl_cmd">
		<tr>
			...
			<td>连接地址</td>
			<td class="icons">
				<div id="editLink" class="Ico_edit" title="编辑"></div>
	...
	<tfoot id="ctrl_cmd1">
		<tr>
			<td colspan="4"><div class="grayBg"><input type="button" value="新建链接" id="addLink" /></div></td>
		</tr>
	</tfoot>
</table>
...
//新建链接
$i('addLink').onclick = function(){
	top.Sio.Alert({width:420,height:200,title:'新建链接',src:'Other/M_Other_addLink.html',button:false});
}
//编辑链接
$i('editLink').onclick = function(){
	top.Sio.Alert({width:420,height:200,title:'编辑链接',src:'Other/M_Other_addLink.html',button:false});
}
