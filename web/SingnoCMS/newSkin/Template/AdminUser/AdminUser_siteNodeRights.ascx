...
<body>
<CMS.Manage:Rights type="site">
站点权限:
</br>
<Rights.Item><Right.Yes></Right.Yes><Right.No><input type="checkbox" name="siteRights" value="{@right.code}" title="{@right.name}" onclick="setSiteRight(this)"/>{@right.name}</Right.No></Rights.Item>
</CMS.Manage:Rights>
</br>
栏目权限:
</br>
<CMS.Manage:Rights type="channel">
站点权限:
<Rights.Item><Right.Yes></Right.Yes><Right.No><input type="checkbox" name="channelRights" value="{@right.code}" title="{@right.name}" onclick="setNodeRight(this)"/>{@right.name}</Right.No></Rights.Item>
</CMS.Manage:Rights>
</br>
选择要设置权限的栏目:</br>
...
<channelsItem><li>{@depthTag}┣<input name="channel" type="checkbox" value="{$nodeid}"  onclick="setNodeList(this)"/>{$nodename}</li></channelsItem></CMS.Manage:channels>
</body>
</html>