...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		...
		var tmpgroupid=1;
		if(parseInt(controlOptions.validatorgroup)>=1)tmpgroupid=controlOptions.validatorgroup;
		if(settings.tidymode){settings.errorfocus=false};
		if(settings.formid!=""){$("#"+settings.formid).submit(function(){return $.formValidator.pageIsValid(controlOptions.validatorgroup);})};
