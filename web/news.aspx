...
void page_init(object sender, EventArgs e)
{
    ...
    pageStyle=1;
    projectId = 1;
    document=new StringBuilder(1455);documentAppendLine("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\r");
...
documentAppendLine("\t<ul><xnl:repeater nodeid=\"33\" sqlcommand=\"select id,title,Summary,adddate from sn_u_article where nodeid=@nodeid order by id desc\"><itemtemplate>\r");
...
documentAppendLine("\t\t\t\t<div class=\"title\"><a href=\"news/{$id}.html\">{$title}</a><span>{[toshortdate('{$adddate}')]}</span></div>\r");
documentAppendLine("\t\t\t\t<div class=\"txt\">{$Summary}</div>\r");
documentAppendLine("\t\t\t\t<div class=\"enter\"><a href=\"news/{$id}.html\">查看</a></div>\r");
