...
{
    public  class Jquery:IXNLTag<WebContext>
    {
        ...
        public string main(XNLTagStruct tagStruct,WebContext XNLPage)
        {
            ...
            else
            {
                ...
                return "\n<script src=\"" + XNLPage.curChannel.siteNode.siteWebPath + "/Common/jquery/jquery.js\" type=\"text/javascript\"></script>";
            }
        }
